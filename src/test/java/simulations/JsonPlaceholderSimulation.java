...
public class JsonPlaceholderSimulation extends Simulation {
     ...
     *
     * Assertions:
     * - Global maximum response time must be below 800 ms
     ...
     */
    {
        setUp(
                ...
                // New: One user, three random requests
                ...
                // New: Three users, one request each, circular feeder
                JsonPlaceholderScenarios.threeUsersCircular.injectOpen(
                        atOnceUsers(3)
                ).protocols(Protocols.jsonPlaceholderProtocol),

                // New: Three users × three iterations each
